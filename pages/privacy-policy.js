			...
			<div className="container">
				<section className="content">
					...
					<div className="content__body">
						...
						<p>Our Privacy Policy was posted on 21 June 2020 and last updated on 21 June 2020. It governs the privacy terms of our website, located at twis.io, and the tools we provide you (the "Website" or the "Service"). Any capitalized terms not defined in our Privacy Policy, have the meaning as specified in our Terms and Conditions</p>
						...
						<ul>
							<li>
								...
								<p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to: Email address, Name, Cookies and Usage Data.</p>
							...
							<li>
								...
								<p>
									Examples of Cookies we use: <strong>session cookies</strong> (we use these cookies to operate our Service) and <strong>preference cookies</strong> (we use these cookies to remember your preferences and various settings).
								</p>
							</li>
						</ul>
						...
						<ul>
							<li>
								<strong>Business Transaction.</strong> If we are involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.
							</li>
							<li>
								<strong>Disclosure for Law Enforcement.</strong> Under certain circumstances, we may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
							</li>
						</ul>
						...
						<h3>Legal Basis for Processing Personal Data Under General Data Protection Regulation </h3>
						<p></p>
						<p>If you are from the European Economic Area (EEA), twis.io legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
						<p>twis.io may process your Personal Data because:</p>
						<ul>
						...
						<p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. twis.io aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
						<p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please contact us.</p>
						<p>In certain circumstances, you have the following data protection rights:</p>
						<ul>
							<li>
								<strong>The right to access, update or to delete</strong> the information we have on you.
							</li>
							<li>
							...
							<li>
								<strong>The right to data portability.</strong> You have the right to be provided with a copy of your Personal Data in a structured, machine-readable and commonly used format.
							</li>
							<li>
								<strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where twis.io relied on your consent to process your personal information.
							</li>
						</ul>
						...
						<ul>
							<li>
								...
								<p>
									...
									<a href="http://www.google.com/intl/en/policies/privacy/" target="_blank" rel="nofollow">
